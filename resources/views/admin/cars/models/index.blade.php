...
<div class="rounded bg-white p-5 shadow md:p-8 mb-8 flex flex-col">
    <div class="flex w-full flex-col items-center md:flex-row">
        ...
        <a href="{{ route('admin.cars.models.create') }}" class="inline-flex items-center justify-center flex-shrink-0 font-medium leading-none rounded-full outline-none transition duration-300 ease-in-out focus:outline-none focus:shadow text-white bg-red-600 border border-solid border-red-600 hover:bg-red-700 hover:border-hover hover:text-white hover:border-transparent px-5 py-0 h-12 text-[15px] lg:text-base h-12 w-full md:w-auto md:ms-6 h-12 w-full md:w-auto md:ms-6">
        ...
        <table class="w-[1000px] bg-white min-w-full table-fixed">
            ...
            <thead class="border-b border-slate-200">
                <tr>
                    ...
                    <th class="text-left ps-1.5 p-2 whitespace-nowrap font-semibold text-slate-900">Models</th>
                    <th class="text-left ps-1.5 p-2 whitespace-nowrap font-semibold text-slate-900">qty</th>
